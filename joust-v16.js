/**
 * JOUST — Williams Electronics 1982 (Build V16)
 * Rounder arcade-mimic sprites (Williams attract colors), solid Web Audio.
 * Landscape flap combat, eggs, pterodactyl, lava troll. Egg physics = V15.
 */
(() => {
  "use strict";
  ...
  function goTitle() {
    ...
    ptero = null;
    hands = [];
    showOV("JOUST", "INSERT COIN", "BUILD V16 — INSERT COIN — PRESS SPACE / FLAP");
    hud();
  }
